# Personal Website — jimwan.github.io
...
## Deployment
Push to `main` branch on `jimwan.github.io` repo. GitHub Actions (`.github/workflows/deploy.yml`) builds and deploys automatically.
